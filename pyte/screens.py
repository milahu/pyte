...
class Screen:
    ...
    def resize(self, lines=None, columns=None, source=""):
    ...
    def set_margins(self, top=None, bottom=None, source=""):
    ...
    def set_mode(self, *modes, source="", **kwargs):
    ...
    def reset_mode(self, *modes, source="", **kwargs):
    ...
    def define_charset(self, code, mode, source=""):
    ...
    def shift_in(self, source=""):
        """Select ``G0`` character set."""
        self.charset = 0

    def shift_out(self, source=""):
        """Select ``G1`` character set."""
        self.charset = 1

    def draw(self, data, source=""):
    ...
    def set_title(self, param, source=""):
        """Set terminal title.
    ...
    def set_icon_name(self, param, source=""):
        """Set icon name.
    ...
    def carriage_return(self, source=""):
    ...
    def restore_cursor(self, source=""):
    ...
    def insert_lines(self, count=None, source=""):
    ...
    def delete_lines(self, count=None, source=""):
    ...
    def insert_characters(self, count=None, source=""):
    ...
    def delete_characters(self, count=None, source=""):
    ...
    def erase_characters(self, count=None, source=""):
    ...
    def erase_in_line(self, how=0, private=False, source=""):
    ...
    def erase_in_display(self, how=0, *args, source="", **kwargs):
    ...
    def ensure_hbounds(self, source=""):
        """Ensure the cursor is within horizontal screen bounds."""
        self.cursor.x = min(max(0, self.cursor.x), self.columns - 1)

    def ensure_vbounds(self, use_margins=None, source=""):
    ...
    def cursor_up(self, count=None, source=""):
    ...
    def cursor_up1(self, count=None, source=""):
    ...
    def cursor_down(self, count=None, source=""):
    ...
    def cursor_down1(self, count=None, source=""):
    ...
    def cursor_back(self, count=None, source=""):
    ...
    def cursor_forward(self, count=None, source=""):
    ...
    def cursor_position(self, line=None, column=None, source=""):
    ...
    def cursor_to_column(self, column=None, source=""):
    ...
    def cursor_to_line(self, line=None, source=""):
    ...
    def bell(self, *args, source=""):
        """Bell stub -- the actual implementation should probably be
        provided by the end-user.
        """

    def alignment_display(self, source=""):
    ...
    def select_graphic_rendition(self, *attrs, source=""):
    ...
    def report_device_attributes(self, mode=0, source="", **kwargs):
    ...
    def report_device_status(self, mode, source=""):
    ...
    def write_process_input(self, data, source=""):
    ...
    def debug(self, *args, source="", **kwargs):
